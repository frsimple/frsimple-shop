...
const getUserInfo = () => {
  return {
    avatarUrl: wx.getStorageSync('userInfo_avatarUrl'),
    nickName: wx.getStorageSync('userInfo_nickName'),
    phoneNumber: wx.getStorageSync('userInfo_phoneNumber'),
  };
};
const setUserInfo = (userInfo) => {
  wx.setStorageSync('userInfo_avatarUrl', userInfo.avatarUrl);
  wx.setStorageSync('userInfo_nickName', userInfo.nickName);
  wx.setStorageSync('userInfo_phoneNumber', userInfo.phoneNumber);
};

const logOut = () => {
  wx.removeStorageSync('userInfo_avatarUrl');
  wx.removeStorageSync('userInfo_nickName');
  wx.removeStorageSync('userInfo_phoneNumber');
