...
public class RedomUtil {
    ...
    public static String getOrderId() {
        String str = "ORDER";
        str += String.valueOf(System.currentTimeMillis());
        str += String.valueOf(RandomUtil.randomNumbers(3));
        return str;
    }
    ...
    public static String getAliTransNo() {
        ...
        str += RandomUtil.randomString(3).toUpperCase();
        return str;
    }
    ...
    public static String getUuid() {
        return new Date().getTime() + "" + RandomUtil.randomString(5).toUpperCase();
    }
    ...
    public static String getProductId() {
        ...
        str += sdf.format(new Date());
        str += RandomUtil.randomString(6).toUpperCase();
        return str;
    }
