          ...
          <t-popup placement="left-bottom">
            ...
            <template #content>
              <img
                ...
                src="https://pengpengyu-test.oss-cn-zhangjiakou.aliyuncs.com/image/gh_3e61169bf354_258.jpg"
              />
            </template>
          </t-popup>
          <!-- 全局通知 -->
...
import weixinMini from '@/assets/weixin-mini-app.svg?component';
