...
export const COLOR_TOKEN: TColorSeries = {
  DEFAULT: {
    '--td-brand-color-1': '#ffe5e1',
    '--td-brand-color-2': '#ffcac2',
    '--td-brand-color-3': '#ffafa2',
    '--td-brand-color-4': '#ff9280',
    '--td-brand-color-5': '#ff6146',
    '--td-brand-color-6': '#ff452a',
    '--td-brand-color-7': '#f01500',
    '--td-brand-color-8': '#d00d00',
    '--td-brand-color-9': '#b00700',
    '--td-brand-color-10': '#900300',
